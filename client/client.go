...
func CreateLotusClient() error {
	...
	Client, _, err = lotusClient.NewFullNodeRPC(context.Background(), host, requestHeader)
	if err != nil {
		return err
	}
	return nil
...
func CreateLotusSignClient() error {
	...
	SignClient, _, err = lotusClient.NewFullNodeRPC(context.Background(), host, requestHeader)
	if err != nil {
		return err
	}
	return nil
